		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Json Data",
									"targetURL": "#comnaveenzjson1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnaveenzjson1-display": {
								"semanticObject": "comnaveenzjson1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.naveen.zjson1",
									"url": sap.ui.require.toUrl("com/naveen/zjson1")
								}
							}
						}
					}
